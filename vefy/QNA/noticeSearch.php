                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT n.myMemberID, n.noticeTitle, n.noticeContent, n.noticeView, m.youName, n.regTime FROM myNotice n JOIN myMember m ON (m.myMemberID = n.myMemberID) ";

                                            switch($searchOption){
                                                case 'title':
                                                    $sql .= "WHERE n.noticeTitle LIKE '%{$searchKeyword}%' ORDER BY myNoticeID DESC LIMIT 5";
                                                    break;
                                                case 'content':
                                                    $sql .= " WHERE n.noticeContent LIKE '%{$searchKeyword}%' ORDER BY myNoticeID DESC LIMIT 5";
                                                    break;
                                                case 'name':
                                                    $sql .= " WHERE m.youName LIKE '%{$searchKeyword}%' ORDER BY myNoticeID DESC LIMIT 5";
                                                    break;
                                            }
