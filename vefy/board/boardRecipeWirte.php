        ...
        <main id="contents">
            <section id="mainCont">
                ...
                <article class="content-article">
                    <div class="boardType">
                    <h3>레시피 글쓰기</h3>
                    <p class="sub_text">나만의 레시피를 적어주세요~</p>
                        <div class="board-write">
                            <form action="boardRecipeWirteSave.php" name="boardWrite" method="post">
                                <fieldset>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="boardContent" id="boardContent" rows="13" class="title-text" placeholder="내용을 입력해주세요" required></textarea>
                                    </div>
                                </fieldset>
