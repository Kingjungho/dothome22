                ...
                <article class="content-article">
                    <div class="boardType">
                        ...
                        <div class="board-write">
                            <form action="qnaWriteSave.php" name="qnaWrite" method="post">
                                <fieldset>
                                    <legend class="ir_so">게시판 글쓰기 영역입니다</legend>
                                    <div>
                                        <label for="qnaTitle">제목</label>
                                        <input type="text" id="qnaTitle" name="qnaTitle" class="title-text" placeholder="제목을 입력해주세요" required autofocus>
                                    </div>
                                    <div>
                                        <label for="qnaContent">내용</label>
                                        <textarea name="qnaContent" id="qnaContent content" rows="60" class="title-text content" placeholder="내용을 입력해주세요" required></textarea>
                                    </div>
                                </fieldset>
